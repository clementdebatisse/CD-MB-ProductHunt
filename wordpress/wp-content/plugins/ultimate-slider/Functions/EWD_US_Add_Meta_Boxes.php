...
function EWD_US_Add_Meta_Boxes () {
	add_meta_box("slide-meta", __("Slide Options", 'ultimate-slider'), "EWD_US_Meta_Box", "ultimate_slider", "normal", "high");
    add_meta_box("us-meta-need-help", __("Need Help?", 'ultimate-slider'), "EWD_US_Need_Help_Meta_Box", "ultimate_slider", "side", "high");
}
add_action( 'add_meta_boxes', 'EWD_US_Add_Meta_Boxes' );

function EWD_US_Need_Help_Meta_Box( $post ) {
    echo "<div class='ewd-us-need-help-box'>";
        echo "<div class='ewd-us-need-help-text'>Visit our Support Center for documentation and tutorials</div>";
        echo "<a class='ewd-us-need-help-button' href='https://www.etoilewebdesign.com/support-center/?Plugin=US' target='_blank'>GET SUPPORT</a>";
    echo "</div>";
}
...
function EWD_US_Meta_Box( $post ) {
	...
	echo "<div class='ewd-us-meta-menu-item meta-menu-tab-active' id='Menu_Content'>" . __("Content", 'ultimate-slider') . "</div>";
	echo "<div class='ewd-us-meta-menu-item' id='Menu_Buttons'>" . __("Buttons", 'ultimate-slider') . "</div>";
	echo "<div class='ewd-us-meta-menu-item' id='Menu_Images'>" . __("Image", 'ultimate-slider') . "</div>";
	echo "</div>";

	echo "<div class='ewd-us-meta-body' id='Body_Content'>";
	echo "<h3>" . __("Content Type", 'ultimate-slider') . "</h3>";
	...
	echo __("Use this post's content", 'ultimate-slider');
	echo "</div>";
	echo "<div class='ewd-us-meta-option-radio'>";
	...
	echo "</div>";
	echo "<div class='ewd-us-meta-option-explanation'>";
	echo __("Use UPCP product content", 'ultimate-slider');
	...
	echo "</div>";
	echo "<div class='ewd-us-meta-option-explanation'>";
	echo __("Use WooCommerce product content", 'ultimate-slider');
	...
	echo __("Max Title Characters", 'ultimate-slider') . ": " . "<input type='text' name='max_title_chars' value='" . $Max_Title_Chars . "' />";
	echo "</div>";
	echo "<div class='ewd-us-meta-sinle-line'>";
	echo __("Max Body Characters", 'ultimate-slider') . ": " . "<input type='text' name='max_body_chars' value='" . $Max_Body_Chars . "' />";
	echo "</div>";
	echo "</div>";

	echo "<div class='ewd-us-meta-body ewd-us-hidden' id='Body_Buttons'>";
	echo "<h3>" . __("Buttons", 'ultimate-slider') . "</h3>";
	echo "<table id='ewd-us-buttons-list-table'>";
	echo "<tr>";
	echo "<th></th>";
	echo "<th>" . __("Text", 'ultimate-slider') . "</th>";
	echo "<th>" . __("Link Type", 'ultimate-slider') . "</th>";
	echo "<th>" . __("Custom Link", 'ultimate-slider') . "</th>";
	echo "</tr>";
	$Counter = 0;
	foreach ($Buttons as $Button) { 
		...
		echo "<option value='0'>" . __("Custom Link", 'ultimate-slider') . "</option>";
