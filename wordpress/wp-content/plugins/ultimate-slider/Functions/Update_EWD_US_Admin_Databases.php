...
function EWD_US_UpdateOptions() {
	...
	if (isset($_POST['autoplay_pause_hover'])) {update_option('EWD_US_Autoplay_Pause_Hover', stripslashes_deep($_POST['autoplay_pause_hover']));}
	...
	if (isset($_POST['hide_from_slider']) and $US_Full_Version == "Yes") {update_option('EWD_US_Hide_From_Slider', $_POST['hide_from_slider']);}
	...
	if (isset($_POST['force_full_width']) and $US_Full_Version == "Yes") {update_option('EWD_US_Force_Full_Width', stripslashes_deep($_POST['force_full_width']));}
