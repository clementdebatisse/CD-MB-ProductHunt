...
function Add_EWD_US_FrontEnd_Scripts() {
    ...
    wp_register_script( 'ultimate-slider', plugins_url('ultimate-slider/js/ultimate-slider.js'), array('jquery', 'jquery-ui-core', 'jquery-effects-slide'), $EWD_US_Version, true);
...
function EWD_US_Output_TinyMCE_Vars() {
    ...
    if ($WC_Categories and !is_wp_error($WC_Categories)) {
...
function Set_EWD_US_Options() {
    ...
    if (get_option("EWD_US_Hide_From_Slider") == "") {update_option("EWD_US_Hide_From_Slider", array());}
