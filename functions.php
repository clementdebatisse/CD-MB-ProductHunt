<?php
/*Ce fichier fait partie de ProductHunt, storefront child theme.
...
if ( ! function_exists( 'suffice_child_enqueue_child_styles' ) ) {
	function ProductHunt_enqueue_child_styles() {
...
add_action( 'wp_enqueue_scripts', 'ProductHunt_enqueue_child_styles' );
